            ...
            Card(
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  title: const Row(
                    children: [
                      Icon(Icons.design_services_outlined, color: Color(0xFFD87093)),
                      SizedBox(width: 12),
                      Text(
                        'Medidas',
                        style: TextStyle(
                  ...
                  return ListTile(
                    ...
                    leading: CircleAvatar(
                      backgroundColor: isDefault 
                          ? const Color(0xFFF3B4C2) 
                          : const Color(0xFFEBEFE5),
                      child: Icon(
                        Icons.design_services_outlined,
                        color: isDefault ? Colors.black87 : Colors.black54,
                        size: 20,
                      ),
                    ),
                    title: Text(
                      isDefault ? 'Padrão do Molde' : 'Perfil $index',
                      style: const TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: 15,
                        color: Colors.black87,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFFEBB2C3),
  ...
  Widget _buildInputField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixText: 'cm',
        suffixStyle: const TextStyle(color: Colors.black54, fontWeight: FontWeight.w500),
        filled: true,
